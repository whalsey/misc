...
class QuadraticCost(object):
    ...
    def delta(z, a, y):
        ...
        return (a-y) * SigmoidActivation.activation_prime(z)
...
class SigmoidActivation(object):
    ...
    def activation_prime(z):
        ...
        return SigmoidActivation.activation(z)*(1-SigmoidActivation.activation(z))

# added by William Halsey
# function from wikipedia: softmax
...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        for l in xrange(2, self.num_layers):
            z = zs[-l]
            sp = self.hidden_activation.activation_prime(z)
            # sp = sigmoid_prime(z)
